...
import (
	...
	validator "github.com/felipefardo/gobid/internal/validator"
...
type CreateProductReq struct {
	...
	BasepriceInCents int32     `json:"baseprice_in_cents"`
...
func (req CreateProductReq) Valid(ctx context.Context) validator.Evaluator {
	...
	eval.CheckField(validator.MinChars(req.Description, 10) &&
		validator.MaxChars(req.Description, 255), "description",
		"this field must have a length between 10 and 255")

	eval.CheckField(req.BasepriceInCents > 0, "baseprice_in_cents", "this field must be greater than 0")
	eval.CheckField(time.Until(req.AuctionEnd) >= minAuctionDuration, "auction_end", "musr be at least two hours duration")
